...
const starData = [
    ...
    { top: 128.2, left: 153.76, url: '/images/constallation/stars/Promotion-Brand.png', title: { top: 124.21, left: 82.35, text: 'Продакт-менеджер' }, directions: ['promotionNewBusiness', 'brandManagement', 'marketing'] },
