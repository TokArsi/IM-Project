...
const starData = [
    {
        ...
        title: {top: -9, left: 11.2, text: 'Маркетинговый аналитик'},
    ...
    },
    {
        ...
        left: 100.24,
        url: '/images/constallation/stars/marketing-analytic-stars/marketing-analytic.png',
        title: {top: 53.59, left: 143.22, text: 'Performance - маркетолог'},
        directions: ['marketing'],
        transform: '',
    },
    {
        top: 136.31,
        left: 177.56,
        url: '/images/constallation/stars/advert-connect/advert-manager.png',
        title: {top: 167.12, left: 124.36, text: 'Менеджер по рекламе'},
    ...
    },
    {
        top: 121.79,
        left: 55.69,
        url: '/images/constallation/stars/advert-connect/account-manager.png',
        title: {top: 101.8, left: -4, text: 'Аккаунт-менеджер'},
    ...
    },
    {
        ...
        title: {top: 70.91, left: 251.32, text: 'Рекламный стратег'},
    ...
    },
    {
        ...
        left: 361.96,
        url: '/images/constallation/stars/marketing-analytic-stars/marketing-analytic.png',
        title: {top: 203.11, left: 402.76, text: 'Специалист по маркетинговым исследованиям'},
        directions: ['marketing'],
        transform: '',
    },
    {
    ...
    },
    {
        ...
        left: 445.49,
        url: '/images/constallation/stars/marketing-analytic-stars/marketing-analytic.png',
        title: {top: 61.82, left: 486.26, text: 'Директор по маркетингу'},
        directions: ['marketing'],
        transform: '',
    },
];
