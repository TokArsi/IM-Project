...
const starData = [
    {
        ...
        title: {top: -14, left: -37.2, text: 'Маркетинговый аналитик'},
    ...
    },
    {
        ...
        left: 100.24,
        url: '/images/constallation/stars/marketing-analytic-stars/marketing-analytic.svg',
        title: {top: 15.59, left: 103.22, text: 'Performance - маркетолог'},
        directions: ['marketing'],
        transform: '',
    },
    {
        ...
        title: {top: 170.62, left: 55.36, text: 'Менеджер по рекламе'},
    ...
    },
    {
        ...
        title: {top: 96.8, left: -53, text: 'Аккаунт-менеджер'},
    ...
    },
    {
        ...
        title: {top: 67.91, left: 200.32, text: 'Рекламный стратег'},
    ...
    },
    {
        ...
        left: 279.61,
        url: '/images/constallation/stars/marketing-analytic-stars/marketing-analytic.svg',
        title: {top: 193.76, left: 227.77, text: 'Менеджер по маркетингу'},
        directions: ['marketing'],
        transform: '',
    },
    {
        ...
        left: 361.96,
        url: '/images/constallation/stars/marketing-analytic-stars/marketing-analytic.svg',
        title: {top: 246.11, left: 359.76, text: 'Специалист по маркетинговым исследованиям'},
        directions: ['marketing'],
        transform: '',
    },
    {
        ...
        left: 385.83,
        url: '/images/constallation/stars/marketing-analytic-stars/marketing-analytic.svg',
        title: {top: 140.83, left: 395.32, text: 'Руководитель отдела маркетинга'},
        directions: ['marketing'],
        transform: '',
    },
    {
        ...
        left: 445.49,
        url: '/images/constallation/stars/marketing-analytic-stars/marketing-analytic.svg',
        title: {top: 39.82, left: 486.26, text: 'Директор по маркетингу'},
        directions: ['marketing'],
        transform: '',
    },
];
