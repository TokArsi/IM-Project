...
const starData = [
    {
        ...
        title: { top: 1.73, left: 0, text: 'Руководитель пресс-службы' },
    ...
    },
    {
        ...
        title: { top: -1.73, left: 146.63, text: 'Пресс-секретарь' },
        directions: ['advertPublicCommunications'],
        transform: '',
    },
    {
        ...
        title: { top: 70.44, left: 299.02, text: 'PR-менеджер' },
    ...
    },
    {
        ...
        title: { top: 162.78, left: 329.46, text: 'Спичрайтер' },
        directions: ['advertPublicCommunications', 'digitalMarketingCommunications'],
        transform: '',
    },
    {
        ...
        title: { top: 203.78, left: 100, text: 'GR-менеджер' },
