...
const starData = [
    { top: 36.49, left: 58.7, url: '/images/constallation/stars/advert-connect/supervisor-press.png', title: { top: 3.73, left: 0, text: 'Руководитель пресс-службы' }, directions: ['advertPublicCommunications'], isActive: false, },
    { top: 35.7, left: 146.21, url: '/images/constallation/stars/advert-connect/press-helper.png', title: { top: 0, left: 146.63, text: 'Пресс-секретарь' }, directions: ['advertPublicCommunications'], isActive: false, },
    { top: 65.07, left: 262.23, url: '/images/constallation/stars/advert-connect/pr-manager.png', title: { top: 70.44, left: 293.02, text: 'PR-менеджер' }, directions: ['advertPublicCommunications', 'digitalMarketingCommunications'], isActive: false, },
    { top: 164.79, left: 307.77, url: '/images/constallation/stars/advert-connect/speech-writer.png', title: { top: 162.78, left: 325.46, text: 'Спичрайтер' }, directions: ['advertPublicCommunications', 'digitalMarketingCommunications'], isActive: false, },
    { top: 199.78, left: 200.44, url: '/images/constallation/stars/promotion/promotion.png', title: { top: 202.78, left: 100, text: 'GR-менеджер' }, directions: ['promotionNewBusiness'], isActive: false, },
];
const directionType = [
