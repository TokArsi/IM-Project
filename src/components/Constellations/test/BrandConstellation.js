...
const starData = [
    {
        ...
        title: { top: 97.85, left: 0, text: 'Influence-маркетолог' },
    ...
    },
    {
        ...
        title: { top: 3.49, left: 101.48, text: 'Бизнес-девелопер' },
    ...
    },
    {
        ...
        left: 227.52,
        url: '/images/constallation/stars/brand-management-stars/brand-management.png',
        title: { top: 9, left: 227.63, text: 'Бренд-стратег' },
        directions: ['brandManagement'],
        transform: '',
    },
    {
        ...
        left: 397.76,
        url: '/images/constallation/stars/brand-management-stars/brand-management.png',
        title: { top: 0, left: 372.09, text: 'Бренд-менеджер' },
        directions: ['brandManagement'],
        transform: '',
    },
    {
        ...
        left: 322.98,
        url: '/images/constallation/stars/brand-management-stars/brand-management.png',
        title: { top: 81.24, left: 359.39, text: 'Специалист по управлению репутацией бренда' },
        directions: ['brandManagement'],
        transform: '',
    },
];
