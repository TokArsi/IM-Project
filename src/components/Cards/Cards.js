...

{
    ...
    task_description: "Категорийный менеджер зачастую отвечает за сбыт определенного сегмента продуктов из ассортимента\
                ...
                <div className="content">
                    ...
                    >
                        <div className="direction-link">
                            ...
                            <img src="/images/contacts/arrow.png" width={21} height={10} alt=""/>
                        </div>
                    </div>
                </div>
            </div>
